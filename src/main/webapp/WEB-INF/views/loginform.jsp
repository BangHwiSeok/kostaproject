...
<body>
	<div id="wrap">
		<div id="main">
			<div class="bg">
				<img
					src="${pageContext.request.contextPath}/resources/images/page_design_bg.jpg"
					alt="배경화면">
				<div class="logo2">
					<img
						src="${pageContext.request.contextPath}/resources/images/login_div_00.png"
						alt="로그인 배경">
				</div>
			</div>
			<!---->
			...
			<div class="reg">
				<a href="#"><img
					src="${pageContext.request.contextPath}/resources/images/login_div_04.png"
					alt="reg"></a>
			</div>
			<div class="login">
				<img
