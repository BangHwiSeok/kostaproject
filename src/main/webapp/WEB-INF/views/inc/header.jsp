...
<div id="wrap">
    	<div id="header">
        	<div class="bg"><img src="${pageContext.request.contextPath}/resources/images/bg.jpg" alt="배경"></div>
        	<div class="logo"><a href="${pageContext.request.contextPath }"><img src="${pageContext.request.contextPath}/resources/images/logo.png" alt="로고"></a></div>
          ...
          <div class="mypage"><a href="${pageContext.request.contextPath }/members/${currentUser.user.u_num}"><img src="${pageContext.request.contextPath}/resources/images/mypage.png" alt="마이페이지"></a></div>
          <ul>
